...
while True:
    ...
    if not ret:
        ...
        cv2.putText(frame, "Apreta F para ir al siguiente filtro", (10, 20), cv2.FONT_HERSHEY_SIMPLEX, .5, (255, 0, 0), 1)
        ...
        if keypressed == 27:
            ...
            try:
                ...
                filters, multi_filter_runtime = load_filter('jasonjoker')
            except:
                filters, multi_filter_runtime = load_filter('jason-joker')
            ...
            try:
                ...
                filters, multi_filter_runtime = load_filter('flower-crown')
            except:
                filters, multi_filter_runtime = load_filter('flower-crown')
